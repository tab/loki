...
//
//	mockgen -source=internal/app/rpcs/proto/sso/v1/permission_grpc.pb.go -destination=internal/app/rpcs/services/permission_mock.go -package=services
//
...
import (
	context "context"
	ssov1 "loki/internal/app/rpcs/proto/sso/v1"
	reflect "reflect"
...
func (m *MockPermissionServiceClient) Create(ctx context.Context, in *ssov1.CreatePermissionRequest, opts ...grpc.CallOption) (*ssov1.CreatePermissionResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*ssov1.CreatePermissionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPermissionServiceClient) Delete(ctx context.Context, in *ssov1.DeletePermissionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockPermissionServiceClient) Get(ctx context.Context, in *ssov1.GetPermissionRequest, opts ...grpc.CallOption) (*ssov1.GetPermissionResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*ssov1.GetPermissionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPermissionServiceClient) List(ctx context.Context, in *ssov1.PaginatedListRequest, opts ...grpc.CallOption) (*ssov1.ListPermissionsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*ssov1.ListPermissionsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPermissionServiceClient) Update(ctx context.Context, in *ssov1.UpdatePermissionRequest, opts ...grpc.CallOption) (*ssov1.UpdatePermissionResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*ssov1.UpdatePermissionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Create mocks base method.
func (m *MockPermissionServiceServer) Create(arg0 context.Context, arg1 *ssov1.CreatePermissionRequest) (*ssov1.CreatePermissionResponse, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockPermissionServiceServer) Delete(arg0 context.Context, arg1 *ssov1.DeletePermissionRequest) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockPermissionServiceServer) Get(arg0 context.Context, arg1 *ssov1.GetPermissionRequest) (*ssov1.GetPermissionResponse, error) {
	m.ctrl.T.Helper()
...
// List mocks base method.
func (m *MockPermissionServiceServer) List(arg0 context.Context, arg1 *ssov1.PaginatedListRequest) (*ssov1.ListPermissionsResponse, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockPermissionServiceServer) Update(arg0 context.Context, arg1 *ssov1.UpdatePermissionRequest) (*ssov1.UpdatePermissionResponse, error) {
	m.ctrl.T.Helper()
