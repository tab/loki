...
func (m *MockRoles) FindRoleDetailsById(ctx context.Context, id uuid.UUID) (*models.Role, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRolesMockRecorder) FindRoleDetailsById(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindRoleDetailsById", reflect.TypeOf((*MockRoles)(nil).FindRoleDetailsById), ctx, id)
}
